...
if(NOT DEFINED CTEST_BINARY_DIRECTORY)
  set(CTEST_BINARY_DIRECTORY "/tmp/sj-peer/")
endif()
...
if(NOT DEFINED CTEST_RUN_TESTS)
    set(CTEST_RUN_TESTS ON)
endif()
...
if(CTEST_RUN_TESTS)
    ...
    if(CTEST_CONFIGURATION_TYPE STREQUAL "Coverage" AND GCOVR_BIN)
        ...
        set(CTEST_CUSTOM_POST_TEST
            ...
            "${GCOVR_BIN} --html --html-details --html-title sj-peer -f ${CTEST_SCRIPT_DIRECTORY}/lib/\\* --exclude-directories .\\*CompilerIdC\\* -r ${CTEST_SCRIPT_DIRECTORY} --object-directory=${CIO_OBJECT_DIRECTORY} -o ${CIO_CTEST_COVERAGE_DIR}/index.html")
